            ...
            return AnimatedContainer(
              ...
              child: Column(
                children: [
                  ...
                  if(StoreAppCubit.get(context).notification.length>0)
                    Expanded(
                      child: ListView.separated(
                          itemBuilder: (context,index)=>InkWell(
                            onTap: (){
                              navigateTo(context, UpdateProductScreen(products: StoreAppCubit.get(context).notification[index]));
                            },
                            child: Padding(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      CircleAvatar(
                                        radius: 30,
                                        backgroundImage: NetworkImage('https://ibrahim-store.com/api/images/${StoreAppCubit.get(context).notification[index].image}'),
                                      ),
                                      SizedBox(
                                        width: 10,
                                      ),
                                      Column(
                                        ...
                                        children: [
                                          Text(
                                            '${StoreAppCubit.get(context).notification[index].name}',
                                            style: TextStyle(
                                                color: Colors.black,
                                                fontFamily: 'tajawal-light',
                                                fontSize: 20
                                          ...
                                          Text(
                                            '${StoreAppCubit.get(context).notification[index].quantity}',
                                            style: TextStyle(
                                                color: fourColor,
                          ...
                          itemCount: StoreAppCubit.get(context).notification.length
                      ),
                    ),
                  if(StoreAppCubit.get(context).notification.length==0)
                    Padding(
