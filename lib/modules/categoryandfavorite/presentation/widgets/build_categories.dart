...
import 'package:store/modules/categoryandfavorite/presentation/screens/product_in_cate_merchant.dart';
    ...
    return GestureDetector(
      onTap: (){
        if(isMerchant) {
          ...
          FavoriteAndCategoryCubit.get(context).getSubCate(data.idCate);
