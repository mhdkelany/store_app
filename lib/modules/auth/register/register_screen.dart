...
import 'package:store/modules/auth/register/verified_screen.dart';
    ...
    return BlocConsumer<RegisterUserMarketCubit, RegisterUserMarketStates>(
      listener: (context, state) {
        if (state is RegisterGetCurrentAddressSuccessState) {
          cityController.text =
              RegisterUserMarketCubit.get(context).place!.locality!;
        }
        if (state is VerifiedPhoneSuccessState) {
          navigateTo(
              ...
              VerifiedScreen(
                  verificationId:
                      RegisterUserMarketCubit.get(context).verificationIdd,
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: MaterialButton(
                onPressed: () {
                  if (RegisterUserMarketCubit.get(context).showBottom ==
                      false) {
                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      RegisterUserMarketCubit.get(context)
                                                  .place ==
                                              null
                                          ? 'جاري جلب الموقع الحالي'
                                          : '${RegisterUserMarketCubit.get(context).place!.country},${RegisterUserMarketCubit.get(context).place!.locality},${RegisterUserMarketCubit.get(context).place!.subLocality}',
                                      style: TextStyle(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomDropdown(
                            ...
                            errorText: 'يجب ان لا يكون فارغاً',
                          ...
                          defaultTextFromField(
                              ...
                              isShow:
                                  RegisterUserMarketCubit.get(context).isShow,
                              onPressedSuffix: () {
                                RegisterUserMarketCubit.get(context)
                          ...
                          defaultButton(
                            function: state is VerifiedPhoneLoadingState
                                ? null
                                : () async {
