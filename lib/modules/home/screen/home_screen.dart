...
class HomeScreen extends StatelessWidget {
      ...
      builder: (context, state) {
        return ConditionalBuilder(
          condition: StoreAppCubit.get(context).homeModel != null &&
              CategoriesAndFavoriteCubit.get(context).categoriesModel != null,
          builder: (context) {
            if (StoreAppCubit.get(context).homeModel!.products.length == 0) {
              ...
              return SmartRefresher(
                enablePullUp: true,
                  ...
                  child: buildProduct(
                      context, StoreAppCubit.get(context).homeModel!, state));
          },
  ...
  Widget buildProduct(context, HomeModel model, StoreAppStates state) =>
          ...
          children: [
            ...
            Container(
              ...
              child: ListView.separated(
                  ...
                  itemBuilder: (context, index) => BuildCategories(
                      context: context,
                      model: CategoriesAndFavoriteCubit.get(context)
                          .categoriesModel!
                          .data[index],
                      index: index),
            ...
            Container(
              ...
              child: ListView.separated(
                  ...
                  itemBuilder: (context, index) => BuildTopSailing(
                      context: context,
                      products:
                          StoreAppCubit.get(context).homeModel!.top[index],
                      index: index),
                  separatorBuilder: (context, index) => SizedBox(width: 15),
                  itemCount:
                      StoreAppCubit.get(context).homeModel!.top.length >= 10
                          ? 10
                          : StoreAppCubit.get(context).homeModel!.top.length),
            ),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20),
              child: Row(
            ...
            ListView.separated(
              ...
              itemBuilder: (context, index) => BuildNewProducts(
                  context: context,
                  products:
                      StoreAppCubit.get(context).homeModel!.products[index],
                  index: index),
