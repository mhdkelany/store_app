...
class MoreProductsScreen extends StatelessWidget {
  const MoreProductsScreen({Key? key}) : super(key: key);
                          ...
                          children: [
                            Container(
                              ...
                              child: CachedNetworkImage(
                                ...
                                key: UniqueKey(),
                                imageUrl:'https://ibrahim-store.com/api/images/${StoreAppCubit.get(context).homeModel!.products[index].image}',
                            ...
                            Padding(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                    ...
                                    color: StoreAppCubit.get(context).isFavorite[StoreAppCubit.get(context).homeModel!.products[index].idProduct]!?Colors.red[50]:Colors.grey[300]
                                ),
                                child: Padding(
                                  ...
                                  child: Icon(
                                    Icons.favorite,
                                    size: 18,
                                    color: StoreAppCubit.get(context).isFavorite[StoreAppCubit.get(context).homeModel!.products[index].idProduct]!?Colors.red:Colors.grey,
                                  ),
                                ),
                              ),
                            ),
                            ...
                            Padding(
                              ...
                              child: Text(
                                '${StoreAppCubit.get(context).homeModel!.products[index].price}د.أ',
                                style: TextStyle(
