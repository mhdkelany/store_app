                ...
                child: Scaffold(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          GestureDetector(
                            onTap: (){
                              StoreAppCubit.get(context).changeBottomForMerchant(index: 0);
                            },
                            child: Row(
                              children: [
                                Icon(Icons.category_outlined,color: StoreAppCubit.get(context).selectedIndexForMerchant==0?fourColor:Colors.grey ,),
                                SizedBox(
                                  width: 5.w,
                                ),
                                Text('منتجاتي',style: TextStyle(color: StoreAppCubit.get(context).selectedIndexForMerchant==0?fourColor:Colors.grey ,fontSize: 18.sp),),
                              ],
                            ),
                          ),
                          GestureDetector(
                            onTap: (){
                              StoreAppCubit.get(context).changeBottomForMerchant(index: 1);

                            },
                            child: Row(
                              children: [
                                Icon(Icons.category_outlined,color:StoreAppCubit.get(context).selectedIndexForMerchant==1?fourColor:Colors.grey ,),
                                SizedBox(
                                  width: 5.w,
                                ),
                                Text('الفئات',style: TextStyle(fontSize: 18.sp,color: StoreAppCubit.get(context).selectedIndexForMerchant==1?fourColor:Colors.grey ),),
                              ],
                            ),
                          )
                        ],
                  ...
                  body: Column(
                    children: [
                                  ...
                                  return InkWell(
                                    onTap: () {
                                      navigateTo(
                                          context,
                                          UpdateProductScreen(
                                            products: StoreAppCubit.get(context)
                                                .productForUserModel!
                                        ...
                                        children: [
                                          Expanded(
                                            child: CachedNetworkImage(
                                              ...
                                              key: UniqueKey(),
                                              imageUrl:
                                                  '$imageUrl${StoreAppCubit.get(context).productForUserModel!.productForUser[index].image}',
                                              imageBuilder:
                      ...
                      if(StoreAppCubit.get(context).selectedIndexForMerchant==1)
                        Expanded(child: BuildGridForCategories(context: context,)),
                    ],
                  ),
                ),
              );
