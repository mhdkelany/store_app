...
class LoginScreen extends StatelessWidget {
  ...
  String patternPassword = r"^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{8,}$"
  ;
          ...
          child: BlocConsumer<LoginUserMarketCubit,LoginUserMarketStates>(
            listener: (context, state)
            {
              ...
              if(state is LoginUserMarketSuccessState)
                {
                  if(state.dataModel.statusProfile!=null)
                  if(!state.dataModel.statusProfile!)
                    {
                      ScaffoldMessenger.of(context).showSnackBar(buildSnackBar(Text('حسابك متوقف لا يمكنك تسجيل الدخول'), Colors.amber, Duration(seconds: 5)));
                    }
                  //if(LoginUserMarketCubit.get(context).dataModel!=null)
                  if(state.dataModel.status!=null)
                    if(state.dataModel.userType==1){
                  if(state.dataModel.status!)
                    {
                      print(state.dataModel.message);
                      print(isMarket);
                      print(state.dataModel.token);
                      CacheHelper.putData(key: 'token', value: state.dataModel.token).then((value) {
                                  ...
                                  child: Form(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          isMarket?'سجل دخولك الان لبيع المزيد من المنتجات':'سجل دخولك الان للحصول على المزيد من المنتجات',
                                          style: Theme.of(context).textTheme.caption,
                                        ),
                                        if(LoginUserMarketCubit.get(context).place!=null)
                                          SizedBox(
                                            height: 5.0,
                                          ),
                                        if(LoginUserMarketCubit.get(context).place!=null)
                                        ...
                                        defaultTextFromField(
                                            ...
                                            suffix: LoginUserMarketCubit.get(context).icon,
                                            ...
                                            ,
                                            isShow: LoginUserMarketCubit.get(context).isShow,
                                            onPressedSuffix: ()
                                            {
                                              LoginUserMarketCubit.get(context).changeVisibilityPassword();
                                            }
                                        ),
                                        SizedBox(
                                          height: 20.0,
                                        ...
                                        defaultButton(
                                            function:state is LoginUserMarketLoadingState? null : (){
                                                ...
                                                if(!isMarket) {
                                               ...
                                               else if(isMarket)
                                                  {
                                                    ...
                                                    FirebaseMessaging.instance.getToken().then((value) {
                                                      LoginUserMarketCubit.get(context).userLogin(phone: phoneController.text, password: passwordController.text,tokenMobile: value,userType: 0);
                                                    }).catchError((error){
                                                      ScaffoldMessenger.of(context).showSnackBar(buildSnackBar( Text(
                                            ...
                                            widget:state is LoginUserMarketLoadingState?
                                            Row(
                                              children: [
                                                Text(
                                                  'الرجاء الانتظار...',
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: ()
                                                {
                                                  RegisterUserMarketCubit.get(context).determinePosition();
