...
import 'package:store/modules/other/other_screens/call_me_screen.dart';
import 'package:store/modules/order/cubit/order_cubit.dart';
import 'package:store/modules/order/presentation/screens/orders_screen.dart';
...
class MenuItems {
  ...
  static var all = <MenuItemDrawer>[address, orders];
}
...
class MenuScreen extends StatelessWidget {
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      if (ProfileCubit.get(context).userInformation != null)
                        Text(
                            '${ProfileCubit.get(context).userInformation!.name}'),
                      SizedBox(
                        height: 5,
                      ),
                      if (ProfileCubit.get(context).userInformation != null)
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              if (ProfileCubit.get(context).userInformation !=
                                  null)
                                Text(
                      ...
                      if (token != null)
                        Padding(
                          ...
                          child: InkWell(
                            onTap: () {
                              OrderCubit.get(context).getOrders(NoParameters());
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                'تسجيل خروج',
                                style: TextStyle(
                                    fontSize: 14, fontFamily: 'tajawal-light'),
                              ),
                            ],
                          ),
                        ),
  ...
  Widget buildMenuItem(MenuItemDrawer itemDrawer) => ListTile(
        ...
        leading: Text(
          '${itemDrawer.title}',
          style: TextStyle(fontSize: 14.sp, fontFamily: 'tajawal-light'),
        ),
        onTap: () {},
      );
}
